    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600">Tool Details</p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900 font-mono bg-gray-50 px-3 py-2 rounded">{tool.slug}</p>
              </div>
              {tool.website_url && (
                <div>
                  ...
                  <a
                    ...
                    className="mt-1 text-sm text-blue-600 hover:text-blue-700 flex items-center gap-2"
                  >
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            {tool.generic_description ? (
              <p className="text-gray-700 leading-relaxed whitespace-pre-wrap">{tool.generic_description}</p>
            ) : (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <dd className="mt-1 text-sm text-gray-900 font-mono">{tool.id}</dd>
              </div>
              {tool.created_at && (
                <div>
